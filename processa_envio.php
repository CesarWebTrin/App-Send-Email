<?php
	...
	try {
	    ...
	    //Recipients
	    $mail->setFrom('usuario@gmail.com', 'Cesar Augusto');
	    ...
	    $mensagem->status['descricao_status']= 'E-mal, enviado com sucesso';
	...
	//alguma lógica que armazene o erro para posterior análise
?>
<!DOCTYPE html>
<html>
	<head>
